        ...
        public async Task<IActionResult> SeedData()
        {
            ...
            if (!_context.RolePermissionTemplates.Any())
            {
                var managerPerms = new Dictionary<string, bool>
                {
                    ...
                    ["rooms.view"] = true, ["rooms.detail"] = true, ["rooms.create"] = true, ["rooms.edit"] = true, ["rooms.delete"] = true, ["rooms.trash"] = true, ["rooms.restore"] = true, ["rooms.schedules"] = true,
                    ["images.view"] = true, ["images.original"] = true, ["images.delete"] = true, ["images.trash"] = true, ["images.restore"] = true,
