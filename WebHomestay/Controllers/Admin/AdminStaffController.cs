    ...
    public class AdminStaffController : Controller
    {
        ...
        private bool ValidateInheritance(Dictionary<string, bool> perms, out string errorMessage)
        {
            var parentChildMap = new Dictionary<string, string[]>
            {
                ...
                ["rooms.view"] = new[] { "rooms.detail", "rooms.create", "rooms.edit", "rooms.delete", "rooms.trash", "rooms.restore", "rooms.schedules" },
                ["images.view"] = new[] { "images.original", "images.delete", "images.trash", "images.restore" },
        ...
        public async Task<IActionResult> ImportPreview(IFormFile file)
        {
            ...
            try
            {
                var result = await _importService.PreviewStaffAsync(file);
        ...
        public async Task<IActionResult> ImportConfirm([FromBody] ConfirmImportRequest request)
        {
            ...
            try
            {
                var result = await _importService.ConfirmStaffAsync(request.CacheKey);
