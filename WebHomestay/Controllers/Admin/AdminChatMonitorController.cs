...
public class AdminChatMonitorController : Controller
{
    ...
    public async Task<IActionResult> CancelApprovedBooking(int id)
    {
        ...
        if (booking.BookingMode == WebHomestay.Models.Enums.BookingMode.Hourly && booking.RoomSlotInventoryId.HasValue)
        {
...
""";
    ...
    private IQueryable<WebHomestay.Models.Entities.Chat.AdminChatSession> BuildAccessibleSessionQuery(bool includeDeleted, bool asNoTracking = false)
    {
    ...
    private Task<WebHomestay.Models.Entities.Chat.AdminChatSession?> FindAccessibleSessionAsync(
        string sessionId,
