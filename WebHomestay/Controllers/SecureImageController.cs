...
namespace WebHomestay.Controllers
{
    ...
    public class SecureImageController : Controller
    {
        ...
        {
            // Cho phép SuperAdmin, Manager HOẶC người có quyền images.view xem ảnh gốc
            var role = HttpContext.Session.GetString("AdminRole");
            bool hasImageView = Helpers.PermissionHelper.HasPermission(HttpContext, "images.view");
            
            if (role != "SuperAdmin" && role != "Manager" && !hasImageView)
            {
