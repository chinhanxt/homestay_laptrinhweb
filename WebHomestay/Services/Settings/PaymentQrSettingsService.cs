...
namespace WebHomestay.Services.Settings
{
    public interface IPaymentQrSettingsService
    {
        ...
        Task<Dictionary<int, PaymentQrSettingsViewModel>> GetSettingsForBranchesAsync(IEnumerable<BranchEntity> branches);
        Task<(bool Success, string Message)> SaveSettingsAsync(PaymentQrSettingsViewModel model, IFormFile? qrImage, string webRootPath);
        Task<PaymentQrDisplayViewModel> BuildDisplayAsync(BookingEntity booking);
    }
    ...
    public class PaymentQrSettingsService : IPaymentQrSettingsService
    {
        ...
        public async Task<Dictionary<int, PaymentQrSettingsViewModel>> GetSettingsForBranchesAsync(IEnumerable<BranchEntity> branches)
        {
        ...
        public async Task<PaymentQrDisplayViewModel> BuildDisplayAsync(BookingEntity booking)
        {
        ...
        private static string BuildTransferContent(string template, BookingEntity booking, string branchName)
        {
